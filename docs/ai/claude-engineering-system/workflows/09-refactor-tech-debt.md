...
Task workflow: `refactor`

product-manager (preserved-behavior contract) -> prd-reviewer -> architect if needed -> developer -> peer-reviewer -> specialists -> regression-tester
