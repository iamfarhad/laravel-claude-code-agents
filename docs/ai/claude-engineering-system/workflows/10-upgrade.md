...
product-manager (compatibility contract) -> prd-reviewer -> architect if needed -> upgrade-developer -> peer-reviewer -> specialists -> regression-tester -> release-reviewer
