...
Task workflow: `production-bug`

qa-support -> product-manager (corrective PRD) -> prd-reviewer -> developer -> peer-reviewer -> specialists -> tester -> release-reviewer if risk requires
